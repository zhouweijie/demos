...
extension ViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func moveToLeftAnimation(cell: AnimatingCell, indexPath: IndexPath) {
        ...
        UIView.animate(withDuration: animationTime, delay: subcribeImageToCircleDelay, options: [], animations: {
            ...
            //更新cell高度
            DispatchQueue.main.asyncAfter(deadline: .now() + self.subcribeImageToCircleDelay, execute: {//使用这行代码，使延时生效
    ...
    func moveUpToDisappear(cell: AnimatingCell, index: IndexPath) {
        UIView.animate(withDuration: animationTime, delay: moveUpDelay, options: [], animations: {
            var successF = cell.success.frame
